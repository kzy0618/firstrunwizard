...
<h2></h2>
        <img src="<?php print_unescaped(OCP\Util::imagePath('firstrunwizard', 'Fileicon.png')); ?>" style="height:120px"/>

<h2><?php p($l->t('Where you can find the applications :')); ?></h2>
<p><?php p($l->t('Click on the arrow on the left top of the screen after going out of this windows to find all the applications'));?></p>
